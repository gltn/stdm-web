...
from .administative_spatial_unit import (
...
from .auto_generate_code import AutoGenerateCode
...
class Profile(object):
    ...
    def __init__(self, name, configuration):
        ...
        :type name: str
        :param configuration: Parent stdm_config object.
        """
        self.name = name
        self.description = ''
    ...
    def sort_entities(self):
        self.entities = OrderedDict(sorted(list(self.entities.items()), key=lambda e: e[1].row_index))
